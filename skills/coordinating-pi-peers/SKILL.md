...
description: Coordinates independently steerable Pi sessions in visible terminal panes. Use when work should be delegated in parallel, when inspecting or messaging a live Pi peer, or when returning a delegated result to a parent session.
